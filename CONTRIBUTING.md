...
[contract page](TODO) need to be updated. The contract page
...
You can see the [actual documentation](TODO) on the website.
...
[proxies page](TODO) makes heavy use of this feature.

You can see an example using the `change` element on the [getting started](TODO)
...
* `smtp` is used for SMTP examples, as on the [mock verification](TODO) page.
...
* `file` is used to create and delete a file, as on the lookup examples on the
  [behavior](TODO) page. It expects a `filename` attribute. If
